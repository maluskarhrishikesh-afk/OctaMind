...
def test_calendar_tool_defaults_use_preference_values(monkeypatch, tmp_path) -> None:
    ...
    monkeypatch.setattr("src.calendar.calendar_service.find_free_slots", lambda date_str, duration_minutes, working_start_hour, working_end_hour, calendar_id="primary": calls.append(("slots", date_str, duration_minutes, working_start_hour, working_end_hour, calendar_id)) or {"status": "success"})
    ...
    assert calls[0] == ("slots", "2026-03-22", 45, 10, 19, "primary")
