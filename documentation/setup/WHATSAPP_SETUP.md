...
## Step 8 - Enable WhatsApp For A Personal Assistant
...
2. Open the Agent Hub at `http://localhost:8501`.

3. Create a Personal Assistant or open an existing one.

4. Open the assistant configuration panel.

5. Enable **WhatsApp** under **Skills** and save.

6. Open the assistant workspace and test WhatsApp-related requests after the webhook configuration in this guide is complete.
